...
##### Keywords #####
# shell 	multi-thread
# shell 	split file evenly for multi-thread process (get_objownerhistory_from_ls())
# shell 	split file according to a pattern line (extractUpdateBySequence()
# shell 	hash value caculate
# shell 	remove huge amount of files at one time
#
####################
